...
<html>
  <head>
    ...
    <script src="https://unpkg.com/@softarc/native-federation-orchestrator@4.6.1/quickstart.mjs"></script>
  </head>
  <body>
...
<html>
  <head>
    ...
    <!-- 1. Init registry -->
    <script src="https://unpkg.com/@softarc/native-federation-orchestrator@4.6.1/init-registry.mjs"></script>
