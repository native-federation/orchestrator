...
disagree about; that is what keeps ragged coverage cheap. A remote whose builds disagree serves its whole
family from its own build, exactly as an islanded one does.
