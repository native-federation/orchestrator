...
import type { LoggingConfig, ModeConfig } from 'lib/core/2.app/config';
import type { DrivingContract } from 'lib/core/2.app/driving-ports/driving.contract';
import type { RemoteEntry, SharedExternal, SharedVersion } from 'lib/core/1.domain';
import type { ForAuditingExternals } from './for-auditing-externals.port';
