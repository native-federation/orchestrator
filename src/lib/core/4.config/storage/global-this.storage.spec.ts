...
import { StorageEntry, StorageEntryHandler } from 'lib/core/2.app/config/storage.contract';
import { mockRemoteInfo_MFE1 } from 'lib/testing/domain/remote-info/remote-info.mock';
